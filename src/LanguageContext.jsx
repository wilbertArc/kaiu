...
const TRANSLATIONS = {
  en: {
    ...
    contact: {
      ...
      enquiryType: 'Enquiry Type', enquiryPh: 'Sample request, project quote, partnership…',
  ...
  id: {
    ...
    contact: {
      ...
      enquiryType: 'Jenis Pertanyaan', enquiryPh: 'Permintaan sampel, penawaran proyek, kemitraan…',
